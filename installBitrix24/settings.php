<?php
define('C_REST_CLIENT_ID','local.67fe7d4487ba03.25426753');//Application ID
define('C_REST_CLIENT_SECRET','mfZtkGy8mDUhOsxcX7nQxFwWvcVlWe8ktI4j8eTxAaEfqFWLjX');//Application key
// or
